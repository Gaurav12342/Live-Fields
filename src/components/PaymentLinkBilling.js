							...
							<Card.Body>
								...
								<Card.Text>
									<div className="d-flex justify-content-between my-1">
										<span className="">{plan_name.text}</span>
										<span className="">
									...
									{props.coupen?.code ? (
										<div className="d-flex justify-content-between my-1">
											<span className="">{props.coupen.code}</span>
											<span className="">
												({props.coupen.discount_type == 'per' ? '%' : ''}
												{props.coupen.discount_type == 'fixed' ? '' : ''}
												{props.coupen.discount}) {props.discountAmount}
											</span>
										</div>
									) : (
										''
